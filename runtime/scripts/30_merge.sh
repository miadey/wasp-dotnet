...
echo '[7.56/9] inject arg trace at mono_assembly_request_open + bundled_resources_get_assembly_resource + mono_assembly_name_new'
...
# (WPBG_FN was resolved earlier, before $WAT was deleted.)
